export const text = {
    title: 'Tại sao lại chọn PhongTro?',
    description: 'Chúng tôi biết bạn có rất nhiều lựa chọn, nhưng Phongtro.com tự hào là trang web đứng top google về các từ khóa: ',
